...
abstract final class WorkoutPlanLibrary {
  static List<WorkoutPlan> get all => const [
        ...
        WorkoutPlan(
          ...
          muscleGroups: ['Full Body'],
          weeklyStructure: [
            PlanDayTemplate(weekday: 1, title: 'Upper', focus: 'Upper push pull'),
            PlanDayTemplate(weekday: 2, title: 'Lower', focus: 'Legs'),
            PlanDayTemplate(weekday: 3, title: 'Rest', isRest: true),
            PlanDayTemplate(weekday: 4, title: 'Full Body', focus: 'Full body'),
            PlanDayTemplate(
              weekday: 5,
              title: 'Core + Cardio',
        ...
        WorkoutPlan(
          ...
          weeklyStructure: [
            PlanDayTemplate(weekday: 1, title: 'Easy Cardio', focus: 'Cardio'),
            PlanDayTemplate(weekday: 2, title: 'Rest', isRest: true),
            PlanDayTemplate(
              weekday: 3,
              title: 'Intervals Lite',
              focus: 'Conditioning',
            ),
            PlanDayTemplate(weekday: 4, title: 'Rest', isRest: true),
            PlanDayTemplate(weekday: 5, title: 'Easy Cardio', focus: 'Cardio'),
            PlanDayTemplate(weekday: 6, title: 'Optional Walk', optional: true),
            PlanDayTemplate(weekday: 7, title: 'Rest', isRest: true),
          ],
        ),
        WorkoutPlan(
          ...
          weeklyStructure: [
            PlanDayTemplate(weekday: 1, title: 'Push', focus: 'Chest shoulders'),
            PlanDayTemplate(weekday: 2, title: 'Rest', isRest: true),
            PlanDayTemplate(weekday: 3, title: 'Pull', focus: 'Back pull'),
            PlanDayTemplate(weekday: 4, title: 'Rest', isRest: true),
            PlanDayTemplate(
              weekday: 5,
              title: 'Legs + Core',
